                    ...
                    <?php 
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                echo "<tr>";
                                echo "<th>" . $row['ma_tgia'] . "</th>";
                                echo "<td>" . $row['ten_tgia'] . "</td>";
                                echo "<td><a href='edit_author.php?id=" . $row['ma_tgia'] . "'><i class='fas fa-edit'></i></a></td>";
                                echo "<td><a href='delete_author.php?id=" . $row['ma_tgia'] . "'><i class='fas fa-trash'></i></a></td>";
                                echo "</tr>";
                            }
                        }
                        ?>
